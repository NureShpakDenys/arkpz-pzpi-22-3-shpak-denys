...
func NewRouter(
	...
	{
		analytics.GET("/:company_id/optimal-route", routeHanler.GetOptimalRoute)
		analytics.GET("/:company_id/weather-alert", routeHanler.GetWeatherAlert)
		analytics.GET("/:company_id/optimal-back-route", routeHanler.GetOptimalBackRoute)
	}
